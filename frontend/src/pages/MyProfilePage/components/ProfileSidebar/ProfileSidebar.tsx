...
export default function ProfileSidebar(props: ProfileSidebarProps) {
    const {
        ...
        location, socialLinks, tags, categories, stats, badges, communities, teams, isPublic,
        ...
        <aside className="profile-sidebar">
            ...
            <div className="sidebar-block">
                ...
                {communities?.length === 0 ? (
                    ...
                    <div
                        key={c.slug}
                        className="community-row clickable"
            ...
            <div className="sidebar-block">
                ...
                {teams?.length === 0 ? (
                    ...
                    >
                        <div className="avatar">
                            {t.avatarUrl ? <img src={t.avatarUrl} alt={t.name} width="100%" height="100%" style={{ borderRadius: '4px' }} /> : <UserIcon />}
                        </div>
                        <div>
                            <p className="community-name">{t.name}</p>
                        </div>
                    </div>
                )) || (
                    <span className="sidebar-empty">немає команд</span>
